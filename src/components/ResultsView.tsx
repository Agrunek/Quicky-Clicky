  ...
  return (
    <>
      <div className="flex min-h-screen w-full flex-col items-center justify-center gap-10">
        <p className="text-2xl font-bold text-white text-shadow-md">{name} completed!</p>
        <div className="flex items-center gap-4">
          ...
          <p className="text-lg font-bold text-white text-shadow-md">Min time: {Math.trunc(minTime)} ms</p>
          <p className="text-lg font-bold text-white text-shadow-md">Max time: {Math.trunc(maxTime)} ms</p>
