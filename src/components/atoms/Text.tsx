...
const baseClassName = tw`text-black oldstyle-nums slashed-zero text-shadow-zinc-200 dark:text-white dark:text-shadow-stone-800`;

const variantClassNames: ClassNameDictionary<TextVariant> = {
  heading: tw`text-2xl font-extrabold text-shadow-lg/50`,
  subheading: tw`text-xl font-semibold text-shadow-sm/30`,
  paragraph: tw`text-base font-normal text-shadow-none`,
};
